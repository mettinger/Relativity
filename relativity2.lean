...
theorem temporalOrder : SpecRel B IB Ph W → ∀ (m k : B) (v : ℝ), IOb B IB W m ∧ IOb B IB W k ∧
  velocitySq B W m k v ∧ v > 0 →
  ∃ (b1 b2: B) (t1 t2 t3 t4: ℝ), time B W m b1 t1 ∧ time B W m b2 t2 ∧
    time B W k b1 t3 ∧ time B W k b2 t4 ∧ t1 < t2 ∧ t4 < t3 := by
      -- Apply the slowerThanLight theorem to derive a contradiction.
